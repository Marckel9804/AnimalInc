...
public class QStock extends EntityPathBase<Stock> {
    ...
    private static final long serialVersionUID = -2014113959L;

    public static final QStock stock = new QStock("stock");

    public final NumberPath<Integer> industry = createNumber("industry", Integer.class);

    public final StringPath realStock = createString("realStock");
